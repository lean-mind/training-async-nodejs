export class Benchmark {
  ...
  get results() {
    const sortedResultsByTotalExecutionsDesc = [...this.#results].sort((a, b) => b.totalExecutions - a.totalExecutions)
    const [first] = sortedResultsByTotalExecutionsDesc
    return sortedResultsByTotalExecutionsDesc.map(result => ({
        ...result,
